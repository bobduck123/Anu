    ...
    <article className="edu-card card-lift p-6 space-y-4">
      ...
      <div className="flex items-center justify-between text-xs">
        ...
        <Link
          ...
          className="manara-glass-chip inline-flex items-center justify-center border border-[var(--edu-border)] bg-black/22 px-3 py-1.5 text-xs font-medium text-[var(--edu-foreground)] transition hover:border-[var(--edu-accent)]/45 hover:bg-[var(--edu-accent-light)] hover:text-[var(--edu-accent)]"
        >
          Explore
        </Link>
      </div>
...
export function EduHubDashboard() {
  ...
  return (
    <section className="space-y-8">
      ...
      {actionableError ? (
        <div className="edu-card border-l-4 border-[var(--edu-accent)] bg-[rgba(242,199,134,0.1)] text-[var(--edu-foreground)]">
          ...
          <Link href={actionableError.fallbackHref} className="mt-2 inline-flex text-sm font-medium text-[#f6d6a3] underline">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link
            href="/education/curriculum"
            className="manara-glass-chip inline-flex items-center justify-center border border-[var(--edu-border)] bg-black/22 px-4 py-2 text-sm font-medium text-[var(--edu-foreground)] transition hover:border-[var(--edu-accent)]/45 hover:bg-[var(--edu-accent-light)] hover:text-[var(--edu-accent)]"
          >
            Open curriculum
          </Link>
        </div>
