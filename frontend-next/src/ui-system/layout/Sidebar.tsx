...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/cost-lowering', label: 'Optimization Studio', icon: Leaf },
      { href: '/runs', label: 'Scenarios', icon: BarChart3 },
      { href: '/pledges', label: 'Commitments', icon: Heart, authRequired: true },
      { href: '/dashboard/savings', label: 'Outcomes', icon: BarChart3, authRequired: true },
  ...
  },
  {
    ...
    adminOnly: true,
    items: [
      { href: '/control/tenants', label: 'Tenants', icon: Shield },
      { href: '/control/runtime-health', label: 'Runtime Health', icon: BarChart3 },
      { href: '/control/atlas', label: 'Atlas Heatmap', icon: LayoutGrid },
      { href: '/control/relief', label: 'Relief', icon: Heart },
      { href: '/control/education', label: 'Education Admin', icon: GraduationCap },
      { href: '/control/ledger', label: 'Ledger', icon: BarChart3 },
      { href: '/control/dumb-dumb', label: 'Dumb Dumb', icon: Sparkles },
