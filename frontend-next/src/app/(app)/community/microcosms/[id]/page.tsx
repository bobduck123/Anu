      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <AnuChamberCard eyebrow="Activity" title="Recent movement">
          {activity.length ? (
            <div className="space-y-3">
              {activity.map((item) => (
                <div key={`${item.type}-${item.id}`} className="flex items-center justify-between rounded-xl border border-[color:rgba(246,212,203,0.1)] bg-[color:rgba(246,212,203,0.04)] px-4 py-3">
                  <div className="flex items-center gap-3">
                    <FileText className="h-4 w-4 text-[color:rgba(246,212,203,0.64)]" />
                    <span className="text-sm text-[var(--color-foreground)]">{item.title}</span>
                  </div>
                  <span className="text-xs text-[color:rgba(246,212,203,0.64)]">
            ...
            <p className="text-sm leading-6 text-[color:rgba(246,212,203,0.82)]">This microcosm is just getting started.</p>
          )}
        </AnuChamberCard>
        ...
        <AnuChamberCard eyebrow="Relation" title="What this chamber holds">
          ...
          <div className="mt-5 flex items-center gap-2">
            <Users className="h-4 w-4 text-[color:rgba(246,212,203,0.64)]" />
            <span className="text-sm text-[color:rgba(246,212,203,0.82)]">{detail.team_count} team chambers currently linked.</span>
          </div>
        </AnuChamberCard>
      </div>
    </div>
